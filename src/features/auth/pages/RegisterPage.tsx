...
import { Eye, EyeOff, Mail, Lock, User, Shield, CheckCircle, XCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12">
        <div className="relative z-10 flex flex-col items-start max-w-md animate-fade-in">
          ...
          <h2 className="text-4xl font-bold leading-tight mb-4">
            Bergabung dan
            <br />
            <span className="text-gradient-primary">mulai sekarang!</span>
          </h2>
          <p className="text-muted-foreground text-lg leading-relaxed mb-10">
            Buat akun gratis dan dapatkan akses ke platform autentikasi yang aman, andal, dan mudah digunakan.
          </p>
          <div className="space-y-3 w-full">
            {['Daftar gratis tanpa kartu kredit', 'Keamanan enterprise-grade', 'Upgrade Premium kapan saja'].map((item) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
        <div className="w-full max-w-md animate-scale-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Isi informasi di bawah untuk memulai</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full glow-primary" size="lg" disabled={registerMutation.isPending}>
              {registerMutation.isPending ? 'Mendaftar...' : (
                <>
